const DEFAULT_SITE_SETTINGS = {
  ...
  ogDescription: 'Operations portal for voyages, finances, and employee administration.',
...
export async function readSiteSettings(env, { bypassCache = false } = {}) {
  ...
  const next = {
    ...
    headerLogoUrl: normalizeUrlValue(map.headerLogoUrl, DEFAULT_SITE_SETTINGS.headerLogoUrl),
...
export async function writeSiteSettings(env, updates, updatedBy = '') {
  ...
  const normalized = {
    ...
    headerLogoUrl: normalizeUrlValue(merged.headerLogoUrl, DEFAULT_SITE_SETTINGS.headerLogoUrl),
